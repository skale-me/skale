...
module.exports.UgridJob = function(request, grid, RAM, msg) {
	...
	for (var i = 0; i < stageData.length; i++)
		stage[i] = new Stage(worker, grid, node, RAM, i, stageData[i], nextStage, master_uuid);
...
function Stage(worker, grid, node, RAM, stageIdx, stageData, nextStage, master_uuid) {
