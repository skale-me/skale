...
var uc;
var input = process.stdin, first = true, fixcode = true, file;
...
if (webid) {
	initCode = 'function plot(data) {' +
		'uc.send(0, {cmd: "plot", id: webid, data: data, file: file});' +
	'}';
	console.log = function (d) {process.stdout.write(JSON.stringify({data: d, file: file}) + '\n');};
}
