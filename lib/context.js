...
var UgridClient = require('./client.js');
var ugrid = require('./dataset.js');
...
function UgridContext(arg) {
	...
	this.parallelize = function (localArray, nPartitions) { return ugrid.parallelize(this, localArray, nPartitions);};
	this.range = function (start, end, step, nPartitions) { return ugrid.range(this, start, end, step, nPartitions);};
