...
Task.prototype.getReadStream = function (fileObj, opt, done) {
  ...
  //var url = 'http://localhost' + fileObj.path;
...
// Same as above getReadStream, but return a stream. This is 
// more expensive, as it requires an additional pass-through stream
