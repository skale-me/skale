...
function Source(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	var partitionMapper = {};
	this.tmp = [];
...
module.exports.stream = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
	...
	grid.on(streamIdx + '.end', function(msg, done) {
		console.log('on ' + streamIdx + '.end');
...
module.exports.parallelize = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
...
module.exports.fromRAM = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
...
module.exports.fromSTAGERAM = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
...
module.exports.randomSVMData = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
...
module.exports.mongo = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
...
module.exports.textFile = function(completedStreams, lid, grid, worker, state, node, RAM, transform, action) {
	Source.call(this, completedStreams, lid, grid, worker, state, node, RAM, transform, action);
