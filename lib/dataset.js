  ...
  const opt = {
    ...
    _preIterate: function (opt, wc, p) {
      ...
      case 'wasb:': {
        ...
        wc.log('save stream:', u.auth, u.path.slice(1) + '/' + p + suffix);

        break;
      }
      case 'file:':
      case null: {
        wc.log('save_preiterate, stream saving to', u.path + '/' + p + suffix);
      ...
      default:
        wc.log('Error: unsupported protocol', u.protocol);
      }
    ...
    _postIterate: function (acc, opt, wc, p, done) {
      ...
      case 'wasb:': {
        ...
        wc.log('upload', wc.exportFile, 'to', u.auth, u.path.slice(1) + '/' + p + suffix);
