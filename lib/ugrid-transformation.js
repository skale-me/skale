...
module.exports.countByValue = function() {
	this.result = {};
...
module.exports.map = function(jobId, grid, node) {
	var mapper = node.src;
	var args = node.args;
...
module.exports.filter = function(jobId, grid, node) {
	var filter = node.src;
...
module.exports.flatMap = function(jobId, grid, node) {
	var mapper = node.src;
...
module.exports.mapValues = function(jobId, grid, node) {
	var mapper = node.src;
...
module.exports.flatMapValues = function(jobId, grid, node) {
	var mapper = node.src;
