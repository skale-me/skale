...
function Action(jobId, grid, action) {
	if (action.src) {
		action.ml = ml;
...
function Transform(jobId, grid, node, worker) {
...
// Actions
// ------------------------------------------------------------------------------------ //
module.exports.takeOrdered = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
...
module.exports.top = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
	var num = action.args[0];
	var sorter = action.args[1];
	this.result = [];
...
module.exports.take = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);	
	this.result = [];
	var num = action.args[0];
...
module.exports.count = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
	this.result = 0;
...
module.exports.collect = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
	this.result = {};
...
module.exports.reduce = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
...
module.exports.lookup = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
	this.result = {};
...
module.exports.countByValue = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
	this.result = {};
...
module.exports.forEach = function(jobId, grid, action) {
	Action.call(this, jobId, grid, action);
	var each = action.src;
...
// Transformations
// ------------------------------------------------------------------------------------ //
module.exports.union = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.pipeline = function (array) {return array;};
};

module.exports.map = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	var mapper = node.src;
	var args = node.args;
...
module.exports.filter = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	var filter = node.src;
...
module.exports.flatMap = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);	
	var mapper = node.src;
...
module.exports.mapValues = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);	
	var mapper = node.src;
...
module.exports.sample = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);	
...
module.exports.groupByKey = function(jobId, grid, node, worker) {		// REWRITE
	Transform.call(this, jobId, grid, node, worker);
	this.result = {};
	var SRAM = this.SRAM = [];
	...
	this.tx_shuffle = function(state) {
		...
		for (var i = 0; i < map.length; i++)
			...
			else grid.request(worker[i], {cmd: 'shuffle', args: map[i], jobId: jobId}, function(err) {if (err) throw new Error(err);});
	};
...
module.exports.reduceByKey = function(jobId, grid, node, worker) {	// REWRITE
	Transform.call(this, jobId, grid, node, worker);
	this.result = {};
...
module.exports.join = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);	
	this.SRAM = [];
...
module.exports.coGroup = function(jobId, grid, node, worker) {		// REWRITE
	Transform.call(this, jobId, grid, node, worker);
	this.result = {};
	var SRAM = this.SRAM = {};
	...
	this.pipeline = function(array, p, from_id) {
		...
		for (var i = 0; i < array.length; i++) {
			...
			if (dest[key][from_id] === undefined) dest[key][from_id] = [];
			dest[key][from_id].push(array[i][1]);
		}
	};
...
module.exports.crossProduct = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.SRAM = [];
...
module.exports.distinct = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.SRAM = [];
	var tmp = [];
	var map = worker.map(function() {return [];});
...
module.exports.intersection = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.SRAM = [];
	var tmp = {};
	tmp[node.child[0]] = [];
...
module.exports.subtract = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.SRAM = [];
	var tmp = {};
	tmp[node.child[0]] = [];
...
module.exports.flatMapValues = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	var mapper = node.src;
...
module.exports.partitionByKey = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.SRAM = [];
	var tmp = {};
	var map = worker.map(function() {return {};});
...
module.exports.sortByKey = function(jobId, grid, node, worker) {
	Transform.call(this, jobId, grid, node, worker);
	this.SRAM = [];
	var tmp = {}, tmp2 = {}, keys = [];
