...
function GroupByKey(node, worker) {		// REWRITE
	this.result = {};
	var SRAM = this.SRAM = [];
...
function ReduceByKey(node, worker) {	// REWRITE
	this.result = {};
...
function CoGroup(node, worker) {		// Rewrite
	this.result = {};
	var SRAM = this.SRAM = {};
...
function CrossProduct(node, worker) {		// REWRITE
	this.result = {};
	var SRAM = this.SRAM = {};
