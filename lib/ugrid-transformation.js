...
function Transform(grid, app, job, stage, node) {
	////////////////////////////////////////////////////////////////////////////////////
	// Modifié pour la généricité de la persistence
	////////////////////////////////////////////////////////////////////////////////////	
	for (var key in node)
		this[key] = node[key];
	delete this.transform; // workaround
...
/* 
TODO: ecriture sur disque sur les wide dependency transform
accumulation de donnée lors du pipeline dans la structure map
accumulation de donnée lors du rx_shuffle pour construire les partitions de l'ex STAGE_RAM
*/
...
module.exports.groupByKey = function(grid, app, job, stage, node) {
	...
	// pendant le pipeline streamer les données directement vers le worker concerné
	this.pipeline = function(array) {
		for (var i = 0; i < array.length; i++) {
			var key = array[i][0];
	...
	// rx_shuffle methode generale, lire le fichier de la STAGE_RAM si il existe
