...
- [Core concepts](#core-concepts)
  ...
  - [Pipeline stages and shuffles](#pipeline-stages-and-shuffles)
...
- [Skale module](#skale-module)
  ...
  - [Dataset methods](#dataset-methods)
    ...
    - [ds.save(url[, options][, done])](#dssaveurl-options-done)
      ...
      - [AWS S3 protocol](#aws-s3-protocol)
      - [Azure blob storage protocol](#azure-blob-storage-protocol)
...
- [Machine Learning module](#machine-learning-module)
  - [ml.binaryClassificationMetrics(measures, options[, done])](#mlbinaryclassificationmetricsmeasures-options-done)
  - [ml.KMeans(nbClusters[, options])](#mlkmeansnbclusters-options)
    - [kmeans.fit(trainingSet[, done])](#kmeansfittrainingset-done)
    - [kmeans.predict(sample)](#kmeanspredictsample)
