...
da0.cartesian(da1).cartesian(da2).map(mapper2).cartesian(da3).map(mapper3).cartesian(da4).map(mapper4).cartesian(da5).map(mapper5).cartesian(da6).map(mapper6).cartesian(da7).map(mapper7).cartesian(da8).map(mapper8).cartesian(da9).map(mapper9).cartesian(da10).map(mapper10).cartesian(da11).map(mapper11).cartesian(da12).map(mapper12).cartesian(da13).map(mapper13).cartesian(da14).map(mapper14).cartesian(da15).map(mapper15).cartesian(da16).map(mapper16).cartesian(da17).map(mapper17).cartesian(da18).map(mapper18).cartesian(da19).map(mapper19).cartesian(da20).map(mapper20).cartesian(da21).map(mapper21).cartesian(da22).map(mapper22).cartesian(da23).map(mapper23).cartesian(da24).map(mapper24).subtract(das).collect().toArray().then(function(res) {console.log(res); uc.end()});
